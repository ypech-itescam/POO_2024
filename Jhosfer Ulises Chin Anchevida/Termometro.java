public class Termometro {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Temperatura maxima en Celsius: " + termometro.getTemperaturaMaxima());
        System.out.println("Temperatura minima en Celsius: " + termometro.getTemperaturaMinima());
        termometro.cambiarAFahrenheit();
        System.out.println("Temperatura maxima en Fahrenheit: " + termometro.getTemperaturaMaxima());
        System.out.println("Temperatura minima en Fahrenheit: " + termometro.getTemperaturaMinima());
    }
}
